              ...
              <div>
                ...
                <div className="pt-4 relative px-4">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-neutral-600 text-lg h-40 md:h-fit pb-10 flex flex-col items-start gap-4 overflow-auto dark:text-neutral-400 [mask:linear-gradient(to_bottom,white,white,transparent)] [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch]"
                  >
      ...
      <ul className="mx-auto w-full space-y-6">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="p-4 flex flex-col md:flex-row justify-between items-start lg:items-center hover:bg-neutral-50 dark:hover:bg-neutral-800 rounded-xl cursor-pointer border border-purple-400"
          >
            <div className="flex gap-4 flex-col md:flex-row ">
              ...
              <div className="">
                <motion.h2
                  ...
                  className="font-medium text-xl lg:text-2xl text-neutral-800 dark:text-neutral-200 text-left md:text-left"
                >
                  {card.title}
                </motion.h2>
                <motion.p
                  layoutId={`description-${card.description}-${id}`}
                  className="text-neutral-600 dark:text-neutral-400 text-lg lg:text-xl md:text-left"
                >
                  {card.description}
                </motion.p>
              </div>
            ...
            <motion.button
              ...
              className="cursor-pointer px-4 py-2 text-xs lg:text-sm rounded-full font-bold bg-gray-100 hover:bg-green-500 hover:text-white text-black mt-4 md:mt-0"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
